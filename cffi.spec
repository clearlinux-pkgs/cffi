...
Source0  : https://files.pythonhosted.org/packages/54/1d/15eae71ab444bd88a1d69f19592dcf32b9e3166ecf427dd9243ef0d3b7bc/cffi-1.14.1.tar.gz
...
%prep
%setup -q -n cffi-1.14.1
cd %{_builddir}/cffi-1.14.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1595863655
...
cp %{_builddir}/cffi-1.14.1/LICENSE %{buildroot}/usr/share/package-licenses/cffi/65e8b9015ffb0747c23370a3d3af2a796c64780e
