...
%prep
%setup -q -n cffi-1.14.2
cd %{_builddir}/cffi-1.14.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1597675805
...
cp %{_builddir}/cffi-1.14.2/LICENSE %{buildroot}/usr/share/package-licenses/cffi/65e8b9015ffb0747c23370a3d3af2a796c64780e
